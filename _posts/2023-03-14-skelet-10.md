...
[^briggs-proof]: It's not easy to find his proof. The best reference I've found is this [Internet Archive backup of a zip](https://web.archive.org/web/20121109222918if_/http://web.mit.edu/~dbriggs/www/Turing72410.zip) which contains several Rich Text Format files with names like "comments on 10th.rtf" and "example for 10th.rtf".
