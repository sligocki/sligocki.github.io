...
$$ \begin{array}{l}
  ...
  \\
  0^\infty & 1 & 3^{n}    & \text{<A} & \to & 0^\infty &   & 3^{4(2^n - 1)} & \text{B>} & 12 \\
\end{array} $$
...
$$0^\infty \; 1 \; 3^{5} \; \text{<A} \; \to \; 0^\infty \; 3^{4(2^5 - 1)} \; \text{B>} \; 12$$
